...
function CheckoutForm() {
  ...
  if (submitResponse && submitResponse === 200) {     
    user.cart = { items: [], total: 0, id:user.cart.id, email: user.email }
  } 
  ...
  return (
    <div className="paper">
      ...
      <h4>Success! Order Placed</h4> : null}</>
